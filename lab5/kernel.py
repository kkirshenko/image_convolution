...
class Kernel:
    ...
    Хранит НЕИЗМЕНЯЕМОЕ внутреннее состояние (матрицу весов),
    которое может быть общим для множества клиентов.
    Объекты Kernel создаются один раз и переиспользуются.
    """
    ...
    def matrix(self) -> np.ndarray:
        return self._matrix  # возвращаем ссылку, т.к. матрица неизменяема
